 ...
 * operators for arithmetic and equality. Exceptions are thrown if division by
 * zero is attempted at any point.
 * 4/24/2015
 * Alex Debrecht */
...
// Set denominator method, to allow for exception to be thrown from all methods
...
void Rational::reduce() {
	...
	this->setDenom(denominator/factor);
...
void Rational::add(Rational b) {
	...
	this->setDenom(denominator * b.denominator);
	reduce();
}
